...
var extendStatics = function(d8, b8) {
  extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d9, b9) {
    ...
    for (var p12 in b9)
      if (Object.prototype.hasOwnProperty.call(b9, p12))
        d9[p12] = b9[p12];
  };
...
function __generator(thisArg, body) {
  ...
  function step(op) {
    ...
    while (g10 && (g10 = 0, op[0] && (_5 = 0)), _5)
      try {
        if (f13 = 1, y6 && (t2 = op[0] & 2 ? y6["return"] : op[0] ? y6["throw"] || ((t2 = y6["return"]) && t2.call(y6), 0) : y6.next) && !(t2 = t2.call(y6, op[1])).done)
          return t2;
        if (y6 = 0, t2)
          op = [op[0] & 2, t2.value];
        switch (op[0]) {
...
function __spreadArray(to, from, pack) {
  if (pack || arguments.length === 2)
    for (var i6 = 0, l13 = from.length, ar; i6 < l13; i6++) {
      if (ar || !(i6 in from)) {
        if (!ar)
...
var u2 = { decode: c3, encode: function(n6) {
  ...
  var t2 = c3(n6).split("").map(function(n7) {
...
function f2(n6, t2) {
  if (n6 === t2)
    return 0;
  for (var r10 = n6.split("."), e10 = t2.split("."), o7 = Math.max(r10.length, e10.length), i6 = 0; i6 < o7; i6++) {
    r10[i6] || (r10[i6] = "0"), e10[i6] || (e10[i6] = "0");
    var a10 = parseInt(r10[i6]) - parseInt(e10[i6]);
    if (0 !== a10)
      return a10 > 0 ? 1 : -1;
  }
  return 0;
...
function p2(t2) {
  var r10 = t2.replace("#", "").match(/.{2}/g) || [];
  if (4 !== r10.length)
    return i.warn("convertArgbToRgba: Received invalid ARGB color"), "";
  var e10 = function(n6) {
    var t3 = d(n6);
    return Math.round(t3 / 255 * 100) / 100;
  }(r10[0]), o7 = d(r10[1]), i6 = d(r10[2]), a10 = d(r10[3]);
...
function s3(t2) {
  ...
  var e10 = d(r10[0]), o7 = d(r10[1]), i6 = d(r10[2]);
  return "".concat(e10, ", ").concat(o7, ", ").concat(i6);
}
function l3(n6) {
  for (var t2 = n6.length, r10 = new ArrayBuffer(t2), e10 = new Uint8Array(r10), o7 = 0; o7 < t2; o7++)
    e10[o7] = n6.charCodeAt(o7);
  return r10;
}
var v = { get: function(n6) {
  var t2 = new RegExp("(?:(?:^|.*;\\s*)".concat(n6, "\\s*\\=\\s*([^;]*).*$)|^.*$"));
  return document.cookie.replace(t2, "$1");
}, set: function(t2, r10, e10) {
  var o7 = t2 + "=" + r10;
  if (e10)
    for (var i6 in e10) {
...
}, remove: function(n6, t2) {
  var r10 = "".concat(n6, "=; expires=Thu, 01 Jan 1970 00:00:00 GMT");
  if (t2)
    for (var e10 in t2)
      r10 += "; ".concat(e10, "=").concat(t2[e10]);
  document.cookie = r10;
} };
var g2 = /* @__PURE__ */ new Set(["400", "401", "403", "404", "429", "500"]);
var w = function(n6) {
  function r10(t2, r11) {
    var e10 = n6.call(this, r11) || this;
    return e10.code = t2, e10;
  }
  return __extends(r10, n6), r10;
}(Error);
function h(n6, t2) {
  return new w(n6, t2 || "");
}
...
function y(n6) {
  ...
  return n6.replace(/\r|\n/g, "").replace(/([\da-fA-F]{2}) ?/g, "0x$1 ").replace(/ +$/, "").split(" ").forEach(function(n7) {
    t2 += String.fromCharCode(parseInt(n7));
  }), window.btoa(t2);
}
var b = function() {
  function n6() {
  ...
  }, n6.prototype.setItem = function(n7, t2) {
    this.map[n7] = t2;
  }, n6.prototype.removeItem = function(n7) {
    delete this.map[n7];
  }, n6.prototype.key = function(n7) {
    var t2 = Object.keys(this.map)[n7];
    return void 0 === t2 ? null : t2;
...
var A2 = { parse: function(n6) {
  return n6.replace(/^\?/, "").replace(/^#\/?/, "").split(/&+/).filter(function(n7) {
    return n7.length > 0;
  }).reduce(function(n7, t2) {
    var e10 = __read(t2.split("=").map(decodeURIComponent), 2), o7 = e10[0], i6 = e10[1], a10 = n7[o7];
  ...
  return Object.keys(n6).map(function(t2) {
    var r10 = n6[t2], e10 = function(n7) {
      return void 0 !== n7 ? "".concat(encodeURIComponent(t2), "=").concat(encodeURIComponent(n7)) : encodeURIComponent(t2);
    };
    return Array.isArray(r10) ? r10.map(function(n7) {
      return e10(n7);
    }).join("&") : e10(r10);
  }).join("&");
} };
...
function x(n6) {
  for (var t2 = "", r10 = 0; r10 < n6; r10++)
    t2 += I2[Math.floor(U2() * I2.length)];
  return t2;
}
function C2(n6) {
  var t2 = new URL(n6), r10 = t2.hash.slice(1).split("&").filter(function(n7) {
    return !D.some(function(t3) {
      return n7.includes("".concat(t3, "="));
    });
  }).join("&");
  return t2.hash = r10, t2.toString();
}
function j(n6) {
  var t2 = new URL(n6);
  return t2.toString().replace(new RegExp(String.raw(S2 || (S2 = __makeTemplateObject(["^", ""], ["^", ""])), t2.origin)), "");
}
var L2 = function(n6) {
  var t2 = j(C2(n6));
...
function O2(n6, t2) {
  ...
  var e10 = new URL(n6);
  return Object.entries(t2).forEach(function(n7) {
    var t3 = __read(n7, 2), o7 = t3[0], i6 = t3[1];
    e10.searchParams.set(o7, i6);
  }), e10.toString();
}
var S2;
var k = ((R2 = {})[s2] = function() {
  var n6 = $(s2);
...
var c4 = null;
function u3() {
  return null === c4 && (c4 = G() || B() && /[#|&]access_token=/.test(location.hash) || "1" === sessionStorage.getItem("".concat(l2, ":").concat(r3)), sessionStorage.setItem("".concat(l2, ":").concat(r3), c4 ? "1" : "0")), !!c4;
}
var f3 = function(n6) {
  function o7() {
...
function a3(n6, t2) {
  if (!t2)
    throw h(n3, "liffId is necessary for liff.init()");
...
function v3(e10, n6, i6) {
  ...
  if (!a10 || !a10.permission)
    return { available: false, error: { code: E, message: "".concat(t2, " is not allowed in this LIFF app") } };
  var l13 = a10.minVer, c14 = a10.unsupportedFromVer;
  if (u3()) {
    var s11 = function(e11, r10) {
      var n7 = r5();
      return !!n7 && !(r10 && f2(n7, r10) > 0) && f2(n7, e11) >= 0;
    }(l13, c14);
    return s11 ? { available: true } : { available: false, error: { code: E, message: "".concat(t2, " is unavailable in this client version.") } };
  }
  return n6 ? { available: true } : { available: false, error: { code: E, message: "".concat(t2, " is not allowed in external browser") } };
}
var g4 = function() {
  return e3() ? !G() && B() ? { available: false, error: { code: E, message: "Subwindow is not supported in this browser" } } : d3() ? { available: false, error: { code: E, message: "this api can be only called in parent window" } } : v3("subwindowOpen", true) : { available: false, error: { code: t, message: "Need access_token for api call, Please login first" } };
};
...
var w3 = function(e10) {
  return function() {
    var r10 = e10();
    if (!r10.available)
      throw h(r10.error.code, r10.error.message);
  };
};
...
function T4(e10) {
  if (!function(e11) {
    ...
    throw h(i3, "Unexpected API name.");
  var r10 = S4[e10];
          ...
          case 2:
            return [2, new Promise(function(e11, o7) {
              ...
              r10.onload = function() {
                ...
                r11 ? e11(r11) : o7(h(I, "Unable to load client features. (Extension is empty)"));
              }, r10.onerror = function() {
                o7(h(I, "Unable to load client features."));
      ...
      switch (t2.label) {
        ...
        case 4:
          return e10 = String(a10.status), r10 = g2.has(e10) ? e10 : e2, [4, a10.json().catch(function() {
            throw h(r10, a10.statusText);
          })];
        case 5:
          throw o7 = t2.sent(), h(o7.error || r10, o7.error_description || o7.message);
      }
    });
  });
}
function u5(e10) {
  var t2 = function(e11) {
    ...
    var t3 = x2();
    if (!t3)
      throw h(t, "Need access_token for api call, Please login first");
...
var m6 = function(e10, r10, s11) {
  return __awaiter(void 0, void 0, void 0, function() {
    var t2, o7, c14, d8, u12, f13, l13;
    return __generator(this, function(n6) {
      switch (n6.label) {
        case 0:
          return n6.trys.push([0, 3, , 4]), t2 = new TextEncoder().encode(e10), [4, v4(r10)];
        case 1:
          for (o7 = n6.sent(), c14 = atob(s11), d8 = new Uint8Array(c14.length), u12 = 0; u12 < c14.length; u12++)
            d8[u12] = c14.charCodeAt(u12);
          return [4, window.crypto.subtle.decrypt({ name: "AES-GCM", iv: t2 }, o7, d8.buffer)];
        case 2:
          return f13 = n6.sent(), [2, new TextDecoder().decode(new Uint8Array(f13))];
        case 3:
          throw l13 = n6.sent(), h(e2, l13);
        case 4:
          return [2];
      }
    });
...
var E4 = function(s11) {
  ...
  this.identification = { identifier: "", cryptoKey: "" }, this.messageHandlerInstance = null, this.listeners = /* @__PURE__ */ new Map(), this.sentMessages = [], this.generateIdentification = function() {
      ...
      return __generator(this, function(l13) {
        switch (l13.label) {
          case 0:
            ...
            }, o8 = this, u12 = { identifier: this.windowType === f6.MAIN ? x(12) : e10.get("liff.subwindow.identifier") || s12("liff.subwindow.identifier") || "" }, this.windowType !== f6.MAIN ? [3, 2] : [4, __awaiter(void 0, void 0, void 0, function() {
              var e11, t2, r10;
              return __generator(this, function(n6) {
                switch (n6.label) {
                  case 0:
                  ...
                  case 2:
                    if (!(t2 = n6.sent()) || !t2.k)
                      throw h(e2, "failed to generate key");
                    return [2, t2.k];
                  case 3:
                    throw r10 = n6.sent(), h(e2, r10);
                  case 4:
                    return [2];
                }
              });
          ...
          case 3:
            return o8.identification = (u12.cryptoKey = d8, u12), [2];
        }
      });
    });
    ...
    return __awaiter(o7, void 0, void 0, function() {
      ...
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            if (!this.isReady())
              throw h("message bus is not ready to send message");
        ...
        switch (n6.label) {
          case 0:
            ...
            if (!e10.identifier || !e10.timestamp)
              throw h(e2, "target message is not valid");
    ...
    return __awaiter(o7, void 0, void 0, function() {
      var t2, r10, s12, a10, o8, c14, d8, u12;
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            return t2 = this.identification, r10 = t2.identifier, s12 = t2.cryptoKey, (a10 = JSON.parse(i6)).data && "string" == typeof a10.data ? (u12 = (d8 = JSON).parse, [4, m6(r10, s12, a10.data)]) : [3, 2];
          case 1:
            return c14 = u12.apply(d8, [n6.sent()]), [3, 3];
          case 2:
...
!function() {
  if ("undefined" != typeof window && "function" != typeof window.CustomEvent) {
    let t2 = function(t3, e10) {
      var i6 = e10 || {}, o7 = i6.bubbles, n6 = void 0 !== o7 && o7, a10 = i6.cancelable, r10 = void 0 !== a10 && a10, d8 = i6.detail, l13 = void 0 === d8 ? void 0 : d8, f13 = document.createEvent("CustomEvent");
      return f13.initCustomEvent(t3, n6, r10, l13), f13;
    };
...
function p8(t2, a10, d8) {
  ...
  var l13 = w2();
  if (!l13)
    throw h(E, "Invalid featureToken for client features");
  if (!window._liff || !window._liff.postMessage)
    throw h(i3, "postMessage is not available from client");
...
function w5(t2, e10, l13) {
  ...
  })) : Promise.reject(h(E, "Invalid featureToken for client features"));
}
...
function dt(n6, r10) {
  return void 0 === r10 && (r10 = {}), __awaiter(this, void 0, void 0, function() {
    var t2, i6, o7, s11, u12, a10, c14, f13;
    return __generator(this, function(e10) {
      switch (e10.label) {
        case 0:
          if (null == (t2 = ut()) ? void 0 : t2.isReady())
            return [3, 5];
          if (i6 = JSON.stringify(r10), o7 = c5().liffId, s11 = lt(), !window.opener || !s11 || !o7)
            throw h(N);
          u12 = false, e10.label = 1;
        case 1:
          return e10.trys.push([1, 3, , 4]), [4, G3(o7)];
        case 2:
          return a10 = e10.sent(), u12 = a10.subwindowCommonModule, [3, 4];
        case 3:
          throw c14 = e10.sent(), i.debug(c14), h(N);
        case 4:
          return f13 = u12 ? s11 : location.origin, [2, new Promise(function(t3) {
            window.addEventListener("message", function e11(r11) {
              (function(t4) {
                if (t4.data && "string" == typeof t4.data.type && [C.SUBMIT, C.CANCEL].includes(t4.data.type))
                  return true;
                return false;
              })(r11) && (window.removeEventListener("message", e11), t3({ status: n6, result: i6 }));
            }), window.opener.postMessage({ status: n6, result: i6 }, f13);
          })];
        case 5:
...
function gt(i6) {
  var o7;
  return __awaiter(this, void 0, void 0, function() {
    var t2, s11, u12, a10, c14, f13, l13, b8, y6, S7, I7;
    return __generator(this, function(e10) {
      switch (e10.label) {
        case 0:
          return (t2 = E2(i6.url)) ? (ht(true), [4, wt()]) : [2, Promise.reject(h(i3, "params.url must be liff url or mini url"))];
        case 1:
          return e10.sent(), nt("ios" !== e6() || P() ? window.open("", "liffsubwindow", "width=480, height=640, menubar=no, toolbar=no, scrollbars=yes") : window.open()), s11 = i6.url, u12 = i6.appData, (a10 = new URL(s11)).searchParams.append(L, "true"), [4, st()];
        case 2:
          ...
          }(a10.hostname), f13 = a10.toString(), [4, G3(t2)];
        case 3:
          if (l13 = e10.sent(), b8 = l13.origin, y6 = l13.subwindowCommonModule, !(S7 = rt()))
            throw h(f);
          if (!y6)
            return S7.close(), [2];
          !function(t3) {
            X2 = t3;
          }(b8), c14.listen(vt), c14.setData("appData", u12), window.addEventListener("message", mt), e10.label = 4;
        case 4:
...
function yt(i6) {
  return __awaiter(this, void 0, void 0, function() {
    var o7, s11, u12, a10, c14, f13, l13, m10, v7, h6, w7, g10, y6, S7, I7 = this;
    return __generator(this, function(P6) {
      switch (P6.label) {
        case 0:
          if (o7 = i6.msit, s11 = i6.mstChallenge, u12 = i6.reconnectCount, a10 = void 0 === u12 ? 0 : u12, c14 = function() {
            ...
            for (var t2 = [], e10 = 0; e10 < arguments.length; e10++)
              t2[e10] = arguments[e10];
            bt = null, i6.onSuccess.apply(i6, __spreadArray([], __read(t2), false));
          }, l13 = function() {
            for (var t2 = [], e10 = 0; e10 < arguments.length; e10++)
              t2[e10] = arguments[e10];
            bt = null, i6.onError.apply(i6, __spreadArray([], __read(t2), false));
          }, m10 = Date.now(), null === bt && (bt = m10), v7 = m10 - bt, a10 >= 10 || v7 > 6e5)
            return l13(h(e2, "Failed to connect")), [2];
          P6.label = 1;
        case 1:
        ...
        case 8:
          return g10 = P6.sent(), w7 = g10 ? h(i3, g10.errorDetail) : h(e2, "Some error happened in the server"), l13(w7), [3, 17];
        case 9:
          return 200 !== h6.status ? [3, 16] : [4, St(h6)];
        case 10:
          if (!(g10 = P6.sent()))
            return l13(h(e2, "Some error happened in the server")), [2];
        ...
        case 12:
          return P6.sent(), [3, 15];
        case 13:
          return f13(y6, S7), [3, 15];
        case 14:
          l13(h(e2, "Some error happened in the server")), P6.label = 15;
        case 15:
          return [3, 17];
        case 16:
          l13(h(e2, "Some error happened in the server")), P6.label = 17;
        case 17:
          return [2];
      }
    });
...
function Pt(n6) {
  var r10 = n6.appData, i6 = n6.native, o7 = c5().liffId, s11 = M(), u12 = E2(n6.url);
  if (!o7)
    return Promise.reject(h(t, "liffId is invalid"));
  if (!s11)
    return Promise.reject(h(t, "mst_challenge is invalid"));
  if (!u12)
    return Promise.reject(h(i3, "params.url must be liff url or mini url"));
  var a10 = Object.assign({}, Ot, i6);
  return function(t2) {
    var e10 = t2.mainLiffId, n7 = t2.subLiffId, r11 = t2.mstChallenge, i7 = t2.appData, o8 = t2.view;
    return e10 && r11 ? f5(l7("subWindowGetMSIT"), { method: "POST", body: JSON.stringify({ mainLiffId: e10, subLiffId: n7, mstChallenge: r11, appData: i7, view: o8 }) }) : Promise.reject(h(i3, "no proper argument"));
  }({ mainLiffId: o7, subLiffId: u12, mstChallenge: s11, appData: r10, view: It(a10) }).then(function(t2) {
    var e10 = t2.msit;
...
function Lt(t2) {
  if (!t2.mst || !t2.status)
    return Promise.reject(h(i3, "no proper argument"));
  var e10 = JSON.stringify(t2);
  return f5(l7("subWindowPost"), { method: "POST", body: e10 });
}
function Et() {
  if (!d3())
    throw h(t, "this api can be only called in child window");
}
function Nt(n6) {
  return void 0 === n6 && (n6 = {}), Et(), u3() ? function(n7) {
    return void 0 === n7 && (n7 = {}), __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(e10) {
        switch (e10.label) {
          case 0:
            return (t2 = D2()) ? [4, Lt({ mst: t2, status: C.CANCEL, result: n7 })] : [2, Promise.reject(h(t, "mst is invalid"))];
          case 1:
  ...
  return void 0 === n6 && (n6 = {}), Et(), u3() ? function(n7) {
    return void 0 === n7 && (n7 = {}), __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(e10) {
        switch (e10.label) {
          case 0:
            return (t2 = D2()) ? [4, Lt({ mst: t2, status: C.SUBMIT, result: n7 })] : [2, Promise.reject(h(t, "mst is invalid"))];
          case 1:
            return r10 = e10.sent(), et(true), [2, r10];
        }
      });
  ...
  return Et(), u3() ? function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(e10) {
        switch (e10.label) {
          case 0:
            return false !== tt() ? [3, 2] : (t2 = D2()) ? [4, Lt({ mst: t2, status: C.CLOSE, result: {} })] : [2, Promise.reject(h(t, "mst is invalid"))];
          case 1:
            e10.sent(), e10.label = 2;
          case 2:
            return r8(), [2];
...
function Bt(t2) {
  ...
  return e10 && n6 ? f5(l7("subWindowGetMSTByMSIT"), { method: "POST", body: JSON.stringify({ msit: e10, mstVerifier: n6 }) }) : Promise.reject(h(i3, "no proper argument"));
}
function Dt(t2) {
  var e10 = t2.mst;
  return e10 ? f5(l7("subWindowGetAppData"), { method: "POST", body: JSON.stringify({ mst: e10 }) }) : Promise.reject(h(i3, "no proper argument"));
}
  ...
  this.type = "sync", this.fns = /* @__PURE__ */ new Set(), this.on = function(n6) {
    ...
    try {
      for (var l13 = __values(e10.fns), c14 = l13.next(); !c14.done; c14 = l13.next()) {
        var f13 = c14.value;
        f13.apply(void 0, __spreadArray([], __read(a10), false));
      }
    } catch (u12) {
      i6 = { error: u12 };
    } finally {
          ...
          case 0:
            ...
            try {
              for (s12 = __values(this.fns), o8 = s12.next(); !o8.done; o8 = s12.next())
                l13 = o8.value, e10.push(l13.apply(void 0, __spreadArray([], __read(a10), false)));
            } catch (u12) {
              c14 = { error: u12 };
            } finally {
              try {
                o8 && !o8.done && (f13 = s12.return) && f13.call(s12);
              } finally {
                if (c14)
                  throw c14.error;
              }
...
var _3 = function(i6) {
  ...
  if (!b8 || !b8.liffId)
    throw h(n3, "You need to define `liffId` for liff.login()");
...
function p9(n6) {
  if (null === c10)
    throw h(I, "please call xlt after liff.init");
  return c10[n6];
}
var d6 = function(i6) {
  function r10() {
...
function Ne(e10) {
  var t2 = e10.iconColor, r10 = e10.statusBarColor, n6 = e10.titleTextColor, o7 = e10.titleSubtextColor, i6 = e10.titleButtonColor, a10 = e10.titleBackgroundColor, c14 = e10.progressBarColor, s11 = e10.progressBackgroundColor, u12 = e10.titleButtonAreaBackgroundColor, d8 = e10.titleButtonAreaBorderColor, h6 = e10.baseBackgroundColor, p12 = e10.baseTextColor, v7 = e10.lightButtonBorderColor;
  De("--liff-base-background-color", h6), De("--liff-base-text-color", p12), De("--liff-base-background-rgb-color", s3(h6)), De("--liff-base-text-rgb-color", s3(p12)), De("--liff-light-button-border-color", v7), De("--liff-title-text-color", n6), De("--liff-title-background-color", a10), De("--liff-title-button-color", i6), De("--liff-icon-color", t2), De("--liff-status-bar-color", r10), De("--liff-title-subtext-color", o7), De("--liff-progress-bar-color", c14), De("--liff-progress-background-color", s11), De("--liff-title-button-area-background-color", p2(u12)), De("--liff-title-button-area-border-color", p2(d8));
}
function De(e10, t2) {
...
var Ue = { addToHomeScreen: function(e10) {
  if (!new o3(e10).invoke("addToHomeScreen"))
    throw h(E, "No permission for liff.addToHomeScreen()");
}, scanCode: function(e10) {
  if (!new o3(e10).invoke("scanCode"))
    return Promise.reject(h(E, "No permission for liff.scanCode()"));
}, getAdvertisingId: function(e10) {
  if (!new o3(e10).invoke("getAdvertisingId"))
    return Promise.reject(h(E, "No permission for liff.getAdvertisingId()"));
...
function je(e10, o7) {
  return __awaiter(this, void 0, void 0, function() {
    var t2, i6, a10, c14, s11, l13, f13, p12, v7, m10, w7, g10, b8, k4, C6, F4;
    return __generator(this, function(r10) {
      switch (r10.label) {
        case 0:
          return t2 = e10.split("."), i6 = __read(t2, 3), a10 = i6[0], c14 = i6[1], s11 = i6[2], l13 = JSON.parse(u2.decode(a10)), f13 = JSON.parse(u2.decodeUnicode(c14)), p12 = l3(u2.decode(s11)), v7 = l3("".concat(a10, ".").concat(c14)), [4, Pe()];
        case 1:
          if (m10 = r10.sent(), !(w7 = m10.keys.find(function(e11) {
            return e11.kid === l13.kid;
          })))
            return [3, 6];
          if (delete w7.alg, "ES256" !== l13.alg)
            throw h(T, 'Invalid "alg" value in ID_TOKEN');
        ...
        case 4:
          throw b8 = r10.sent(), h(T, "".concat("Failed to use Crypto API to verify ID_TOKEN", ": ").concat(b8));
        case 5:
          if (g10) {
            if (k4 = f13.iss !== "https://access.".concat("line.me"), C6 = f13.aud !== o7, F4 = 1e3 * f13.exp < Date.now(), k4)
              throw h(T, 'Invalid "iss" value in ID_TOKEN');
            if (C6)
              throw h(T, 'Invalid "aud" value in ID_TOKEN');
            if (F4)
              throw h(T, 'Invalid "exp" value in ID_TOKEN');
            return [2, f13];
          }
          throw h(T, "Invalid signature in ID_TOKEN");
        case 6:
          throw h(T, 'Invalid "kid" value in ID_TOKEN');
        case 7:
          return [2];
      }
    });
      ...
      switch (r10.label) {
        case 0:
          return t2 = A2.parse(window.location.hash), n6 = function(e11) {
            for (var t3, r11, n7 = [], i7 = 1; i7 < arguments.length; i7++)
              n7[i7 - 1] = arguments[i7];
            var a11 = function(t4) {
...
function Qe(e10) {
  var n6, o7;
  return __awaiter(this, void 0, void 0, function() {
    var t2, i6, a10, c14, l13, f13, d8, h6, v7, g10, b8, C6, F4, I7, y6, _5, B3;
    return __generator(this, function(r10) {
      switch (r10.label) {
        case 0:
        ...
        case 2:
          if (t2 = r10.sent(), i6 = t2.access_token, a10 = t2.context_token, c14 = t2.feature_token, l13 = t2.id_token, f13 = t2.client_id, d8 = t2.mst_verifier, h6 = t2.mst_challenge, v7 = t2.msit, a10) {
            if ("string" != typeof a10)
              throw h(I, "Cannot get context token, perhaps there is an incorrect parameter in permanent link");
            I3(He(a10));
          }
          if (void 0 !== (null === (n6 = E3()) || void 0 === n6 ? void 0 : n6.liffId) && (null === (o7 = E3()) || void 0 === o7 ? void 0 : o7.liffId) !== e10.liffId)
            throw h(I, "Invalid LIFF ID");
          return !d3() && c14 && (!function(e11, t3) {
            T4("multipleLiffTransition") && Ke({ pathname: "app/".concat(e11), query: { feature_token: t3 } });
          }(e10.liffId, c14), Ve() && U3(c14)), h6 && R3(h6), d8 && A3(d8), f13 && F2(f13), v7 && C3(v7), window.addEventListener("pageshow", Ge), e3() ? [3, 5] : c14 && i6 ? [3, 5] : Ve() ? (g10 = O2(location.href, { "liff.hback": "2" }), _3({ redirectUri: g10 }), [4, new Promise(function() {
          })]) : [3, 4];
        case 3:
          r10.sent(), r10.label = 4;
        case 4:
          throw _3(), h(I, "Failed to parse feature_token or access_token");
        case 5:
          return i6 && c14 ? [4, d4(i6)] : [3, 7];
        case 6:
          if (b8 = r10.sent(), C6 = b8.client_id, F4 = b8.expires_in, I7 = m2(e10.liffId), C6 !== I7)
            throw _3(), h(I, "Failed to verify access_token");
        ...
        case 10:
          return l13 && !X() && G2(l13), l13 && f13 && !Z() ? [4, je(l13, f13)] : [3, 12];
        case 11:
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r10) {
      switch (r10.label) {
        ...
        case 1:
          if (a10 = r10.sent(), !(c14 = a10.contextToken))
            throw h(I, "Can not get context from server.");
          if (!(s11 = He(c14)))
            throw h(I, "Invalid context token.");
          return [2, s11];
      }
    });
  });
          ...
          n6 = function() {
            return __awaiter(a10, void 0, void 0, function() {
              ...
              return __generator(this, function(r10) {
                switch (r10.label) {
                  case 0:
                    return [4, (s11 = c5(), l13 = A2.parse(window.location.search), f13 = J2(), u12 = { grant_type: "authorization_code", client_id: l13.liffClientId, appId: s11.liffId, code: l13.code, code_verifier: f13.codeVerifier, redirect_uri: s11.redirectUri || l13.liffRedirectUri, id_token_key_type: "JWK" }, d8 = A2.stringify(u12), f5(l7("token"), { method: "POST", headers: { "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8" }, body: d8 }))];
                  case 1:
...
function $e() {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(f13) {
      switch (f13.label) {
        case 0:
          return (n6 = ut()) ? [3, 2] : [4, st(f6.SUB)];
        case 1:
          n6 = f13.sent(), f13.label = 2;
        case 2:
          return (e10 = n6).isReady() ? (o7 = x(8), [4, e10.getData("appData")]) : [3, 8];
        case 3:
          return i6 = f13.sent(), a10 = i6.eventName, c14 = i6.data, a10 !== d5.NOT_FOUND ? [3, 6] : [4, e10.teardown()];
        case 4:
          return f13.sent(), [4, $e()];
        case 5:
          return [2, f13.sent()];
        case 6:
          c14 && N2(JSON.stringify(c14)), f13.label = 7;
        case 7:
...
var et2 = new (function() {
  function e10() {
    ...
    this.getAndValidateContext = function() {
      var e12 = E3();
      if (!e12)
        throw h(I, "Could not get Context from server.");
      if (!e12.endpointUrl)
        throw h(I, "Could not get endpointUrl from server.");
      if (!e12.permanentLinkPattern)
        throw h(I, "Could not get permanentLinkPattern from server.");
      return e12;
    }, this.decodeState = function(t2) {
      var r10 = e11.getAndValidateContext();
      t2 = t2.replace(/\n/g, "%0D%0A");
      var n6 = !r10.endpointUrl.startsWith("/?") && r10.endpointUrl.includes("/?") || !r10.endpointUrl.startsWith("/#") && r10.endpointUrl.includes("/#") || r10.endpointUrl.endsWith("/") || !t2.startsWith("/?") && t2.includes("/?") || !t2.startsWith("/#") && t2.includes("/#") || t2.endsWith("/"), o7 = new URL(r10.endpointUrl), i6 = o7.origin, a10 = o7.pathname, c14 = o7.search, s11 = new URL("".concat(i6).concat(e11.attachSlashAtStart(t2))), l13 = s11.pathname, f13 = s11.search, u12 = s11.hash, d8 = "".concat(c14).concat(c14 ? f13.replace(/\?/g, "&") : f13), h6 = "".concat(a10).concat(e11.attachSlashAtStart(l13)).replace("//", "/");
      return (h6 = e11.attachSlashAtStart("".concat(h6))).endsWith("/") && !n6 && (h6 = h6.substring(0, h6.length - 1)), "".concat(i6).concat(h6).concat(d8).concat(u12).replace(/%0D%0A/g, "\n");
    };
  }
      ...
      return __generator(this, function(r10) {
        switch (r10.label) {
          case 0:
            ...
            r10.label = 1;
          case 1:
            return r10.trys.push([1, 4, , 5]), n6 = location.href, (o7 = this.decodeState(t2)) === n6 ? [3, 3] : (e11["liff.hback"] ? location.replace(O2(o7, { "liff.hback": e11["liff.hback"] })) : location.replace(o7), [4, new Promise(function() {
            })]);
          case 2:
      ...
      switch (r10.label) {
        ...
        case 2:
          if (t2.error && t2.liffOAuth2Error)
            throw a10 = t2.error, c14 = t2.error_description, l13 = c14.replace(/\+/g, " "), f13 = "".concat(a10, ": ").concat(l13), h(I, f13);
        ...
        case 10:
          return r10.sent(), L2(window.location.href), [2];
      }
      var o7, i6, a10, c14, l13, f13;
    });
  });
}
        ...
        case 3:
          return t2.sent(), [4, (r10 = x(6), new Promise(function() {
            ...
            t3 && t3.addEventListener("lui-button-click", function() {
              var e12 = window.open(O2(window.location.href, { liffIsEscapedFromApp: "true" }), "_blank");
              e12 && (e12.location.href = O2(window.location.href, { liffIsEscapedFromApp: "true" }), window.close());
            });
          }))];
        case 4:
          return t2.sent(), [2];
...
function k3(r10) {
  return __awaiter(this, void 0, void 0, function() {
    var t2, i6, o7, u12, f13, h6, v7;
    return __generator(this, function(n6) {
      switch (n6.label) {
        case 0:
          return function(t3) {
            if (!U.includes(t3))
              throw h(i3, "Unexpected permission name.");
            var n7 = E3();
        ...
        case 1:
          ...
          try {
            for (u12 = __values(o7), f13 = u12.next(); !f13.done; f13 = u12.next())
              if (f13.value.includes(r10))
                return [2, { state: "granted" }];
          } catch (m10) {
            h6 = { error: m10 };
          } finally {
            try {
              f13 && !f13.done && (v7 = u12.return) && v7.call(u12);
            } finally {
              if (h6)
                throw h6.error;
            }
...
function S5() {
  var t2 = c5().liffId;
  if (t2)
    return f5("".concat(l7("unauthorizedPermissions"), "?liffId=").concat(t2), { headers: { "Content-Type": "application/json", Accept: "application/json", Authorization: "Bearer ".concat(x2()) } });
  throw h(t, "liffId is required");
}
var T5;
var q3 = At.on;
var P3 = At.off;
...
var E5 = function() {
  function e10(e11, r10) {
    ...
    this.onSubmit = function(e12) {
      ...
      return __awaiter(i6, void 0, void 0, function() {
        return __generator(this, function(t2) {
          return r11 ? this.resolve({ newAccessToken: r11 }) : o7 && this.reject(h(e2, o7)), this.teardown(), [2];
        });
      });
    }, this.onClose = function() {
      return __awaiter(i6, void 0, void 0, function() {
        return __generator(this, function(t2) {
          return this.reject(h(t, "user didn't allow the agreement")), this.teardown(), [2];
        });
      });
  ...
  return e10.prototype.setup = function() {
    ...
    var n6 = c5().liffId;
    n6 ? x3({ url: "".concat("https://liff.line.me/1656032314-Xgrw5Pmk"), appData: { liffId: n6, channelId: m2(n6), accessToken: x2() }, onBeforeTransition: t2 }).catch(this.reject) : this.reject(h(t, "liffId is required"));
  }, e10;
}();
function _4() {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(o7) {
      switch (o7.label) {
        case 0:
          if (!A4())
            throw h(E, "SkipChannelVerificationScreen is unavailable.");
                ...
                switch (n6.label) {
                  ...
                  case 1:
                    if (t2 = n6.sent(), (u3() ? t2 : t2.filter(function(t3) {
                      ...
                      throw h(E, "All permissions have already been approved.");
                    return [2];
                }
              });
            });
...
function R4(e10, o7) {
  var s11 = this;
  return function() {
    for (var c14 = [], a10 = 0; a10 < arguments.length; a10++)
      c14[a10] = arguments[a10];
    return __awaiter(s11, void 0, void 0, function() {
      var t2, s12, a11;
      return __generator(this, function(n6) {
        switch (n6.label) {
          ...
          case 1:
            if ("unavailable" !== (a11 = n6.sent().state))
              return [3, 2];
            throw h(E, "The permission is not in LIFF app scope.");
          case 2:
...
function p10(n6) {
  if (!function(n7) {
    if (!n7 || "object" != typeof n7)
      return false;
    var t2 = n7, o7 = t2.url, e10 = t2.external, r10 = __read([typeof o7, typeof e10], 2), f13 = r10[0], l13 = r10[1];
    return "string" === f13 && "" !== o7 && ("undefined" === l13 || "boolean" === l13);
  }(n6))
    throw h(i3, "Invalid parameters for liff.openWindow()");
  var u12 = r5();
  if (u3())
    if (null !== u12 && "ios" === e6() && f2(u12, "9.19") >= 0 || !window._liff.postMessage) {
      ...
      window.open(function(n7, t2) {
        var o7, e10, r10, f13, l13, c14, u13, p13, s12;
        (function(n8) {
          return -1 !== n8.indexOf("#") && -1 !== n8.indexOf("?") && n8.indexOf("#") < n8.indexOf("?");
        })(n7) || function(n8) {
          return -1 === n8.indexOf("?") && -1 !== n8.indexOf("#");
        }(n7) ? (u13 = (o7 = __read(n7.split("#"), 2))[0], e10 = o7[1], p13 = (r10 = __read((void 0 === e10 ? "" : e10).split("?"), 2))[0], s12 = r10[1]) : (u13 = (f13 = __read(n7.split("?"), 2))[0], l13 = f13[1], s12 = (c14 = __read((void 0 === l13 ? "" : l13).split("#"), 2))[0], p13 = c14[1]);
        var d9 = a8(s12, p13);
...
function p11(r10) {
  return Promise.reject(h(i3, r10));
}
function l11(r10) {
  if (!function(r11) {
...
var I4 = function(u12) {
  ...
  return __extends(d8, u12), Object.defineProperty(d8, "CUSTOMPLACEID_INIT", { get: function() {
    return "liff.init";
    ...
    return __awaiter(this, void 0, void 0, function() {
      var t2, i6, r10, u13, d9, h6, g10, I7, m10, L6, S7, v7;
      return __generator(this, function(e10) {
        switch (e10.label) {
          case 0:
            if (t2 = A2.parse(window.location.search), this.prepareReferrer(t2), i6 = E3(), !(r10 = null == i6 ? void 0 : i6.utsTracking))
              return [2];
            if (u13 = c5(), d9 = u13.liffId, h6 = u13.analytics, "auto" !== r10.mode || !h6)
              return [3, 6];
...
var d7 = /([\x90\x9D\x81\x8D\x8F<"{|}>\\^`“›„•‚ŽŠ…’—ž–‘”‡™‰ŒšŸ‹œ†¥¿©áÄýÍÎðô]|\n|.*#.*#|%(?![0-9A-Fa-f]{2})[^%]{0,2})/;
var g8 = function(n6) {
  if (d7.test(n6))
    throw h(i3, "invalid URL.");
...
var L4 = function(n6, t2) {
  ...
  if (r10.username !== e10.username || r10.password !== e10.password)
    throw h(i3, "invalid URL.");
  if (e10.origin !== r10.origin || !b7(e10.pathname, r10.pathname))
    throw h(i3, "invalid URL.");
};
var P4 = function(n6) {
  function t2() {
    ...
    return t3.extraParams = "", t3.getAndValidateContext = function() {
      ...
      if (l13.origin !== s11 || !b7(l13.pathname, e10))
        throw h(n3, "Current page is not under entrypoint.");
      ...
      return __awaiter(t3, void 0, void 0, function() {
        var t4, r10, e10, a10, o7, u12;
        return __generator(this, function(i6) {
          if (!(t4 = c5().liffId))
            throw h(I, "Should run after liff init.");
          return r10 = this.getAndValidateContext(), L4(n7, r10.endpointUrl), e10 = g8(n7), a10 = new URL(r10.endpointUrl), o7 = r10.miniDomainAllowed ? a2 : s2, u12 = r10.miniDomainAllowed && r10.miniAppId ? r10.miniAppId : t4, [2, o7.concat(u12, w6(e10.pathname, a10.pathname), x4(e10.search, a10.search), U4(e10.hash))];
        });
      });
  ...
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(o7) {
      return C4.scanCodeV2(), s9 && s9.destroy(), [2, new Promise(function(o8, t2) {
        s9 = new u10(o8, t2), At.open({ url: "https://liff.line.me/1656359117-jxmx5e11" }).catch(function(o9) {
...
function c13(e10, r10, o7, i6) {
  ...
  return new Promise(function(t2) {
    ...
    !function(t3, e11) {
      n5[t3] = e11;
    }(r10, f13), e10.addEventListener(c14, f13, !!a9 && i6);
  });
}
function u11(t2, o7, n6, i6) {
  if (void 0 === n6 && (n6 = {}), "object" != typeof t2 || !t2.postMessage)
    throw h(i3, "target must be window object");
  if ("string" != typeof o7)
    throw h(i3, "keyname must be string");
  if ("object" != typeof n6)
    throw h(i3, "incorrect body format. It should be Object or Array comprised of Object");
  if (!i6)
    throw h(i3, "serverEndPointUrl isn't passed. please fill up with proper url");
  if ("*" === i6)
...
var I5 = function() {
  ...
  return i6.getInstance = function() {
    ...
    return void 0 === t2 && (t2 = l7("shareTargetPicker")), F(t2);
          ...
          switch (e10.label) {
            case 0:
              if (C4.shareTargetPicker(), !r11 || !Array.isArray(r11) || 0 === r11.length)
                throw h(i3, "no proper argument");
              if (r11.length > O)
                throw h(i3, "exceed the limit of num of messages");
              if (!(t2 = c5().liffId))
                throw h(n3);
            ...
            case 2:
              return [2, e10.sent()];
            case 3:
              throw (v7 = e10.sent()) instanceof w ? v7 : h(N, v7.message);
            case 4:
              return [2];
          }
        });
...
function g9(t2) {
  if (T2(t2))
    throw h(i3, "LINE URL scheme are not supported in the current environment.");
}
function I6(n6, e10) {
  return __awaiter(this, void 0, void 0, function() {
    var t2;
...
function H4(n6) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(t2) {
      switch (t2.label) {
        case 0:
          return C4.internalCreateShortcutOnHomeScreen(), [4, U5(n6)];
        case 1:
          return t2.sent(), [2];
      }
    });
...
function L5(n6) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(t2) {
      switch (t2.label) {
        case 0:
          return C4.createShortcutOnHomeScreen(), [4, U5(n6)];
        case 1:
          return t2.sent(), [2];
      }
    });
    ...
    return __generator(this, function(r10) {
      switch (r10.label) {
        case 0:
          if (function(t3) {
            var r11;
            if (void 0 === t3.url || null === t3.url || "" === t3.url)
              throw h(i3, "no proper argument");
            var n7 = E3();
            if (!(null === (r11 = null == n7 ? void 0 : n7.availability.addToHomeLineScheme) || void 0 === r11 ? void 0 : r11.permission)) {
              if (T2(t3.url))
                throw h(E, "No permission to specify line schema in url.");
              if (t3.description)
                throw h(E, "No permission to specify description.");
            }
            if (!T2(t3.url)) {
              if (!n7)
                throw h(E, "Could not get Context from server.");
              n7.liffId !== E2(t3.url) && L4(t3.url, n7.endpointUrl);
            }
          }(n6), !(t2 = c5().liffId))
            throw h(I, "Invalid LIFF ID.");
