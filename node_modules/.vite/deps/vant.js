...
var stdin_default16 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderCancel = () => {
      const text = props2.cancelButtonText || t("cancel");
      return createVNode("button", {
        "type": "button",
    ...
    const renderConfirm = () => {
      const text = props2.confirmButtonText || t("confirm");
      return createVNode("button", {
        "type": "button",
...
var [name37, bem36] = createNamespace("barrage");
  ...
  setup(props2, {
    ...
    return () => {
      ...
      return createVNode("div", {
        "role": "gridcell",
        "style": style.value,
        "class": [bem37("day", type), className],
...
var [name40] = createNamespace("calendar-month");
...
var stdin_default42 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderDay = (item, index) => createVNode(stdin_default41, {
      "item": item,
      "index": index,
      "color": props2.color,
  ...
  setup(props2, {
    ...
    const renderPlaceholder = () => {
      if (loading.value && props2.showLoading) {
        return createVNode("div", {
          "class": bem38("loading")
        }, [renderIcon(props2.loadingIcon, bem38("loading-icon"), slots.loading)]);
      }
      if (error.value && props2.showError) {
        return createVNode("div", {
          "class": bem38("error")
        }, [renderIcon(props2.errorIcon, bem38("error-icon"), slots.error)]);
      }
    };
    const renderImage = () => {
...
var Image2 = withInstall(stdin_default45);

// node_modules/vant/es/card/Card.mjs
var [name43, bem39] = createNamespace("card");
var cardProps = {
  tag: String,
  num: numericProp,
  desc: String,
...
var stdin_default46 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderTitle = () => {
      ...
      if (props2.title) {
        return createVNode("div", {
          "class": [bem39("title"), "van-multi-ellipsis--l2"]
        }, [props2.title]);
      }
    };
    ...
    const renderPriceText = () => {
      ...
      return createVNode("div", null, [createVNode("span", {
        "class": bem39("price-currency")
      }, [props2.currency]), createVNode("span", {
        "class": bem39("price-integer")
      }, [priceArr[0]]), createTextVNode("."), createVNode("span", {
        "class": bem39("price-decimal")
      }, [priceArr[1]])]);
    };
    return () => {
      var _a, _b, _c;
...
var stdin_default47 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderHeader = () => props2.showHeader ? createVNode("div", {
      ...
      "name": props2.closeIcon,
      "class": [bem40("close-icon"), HAPTICS_FEEDBACK],
      "onClick": onClose
    }, null) : null]) : null;
...
var CHECKBOX_GROUP_KEY = Symbol(name46);
...
var [name47, bem43] = createNamespace("checkbox");
...
var Checkbox = withInstall(stdin_default50);
